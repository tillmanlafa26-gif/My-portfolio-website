...
export default function ResumePortfolio() {
  ...
  return <main ref={pageRef} className={styles.page} onKeyDown={(e) => { if (e.key === 'Escape') closeMenu(); }}>
    ...
    <section className={styles.hero} id='top'>
      <div className={styles.heroCopy} data-reveal><p className={styles.eyebrow}>Front-end developer · Army veteran</p><h1>I turn complex<br/>problems into<br/><em>clear progress.</em></h1><p className={styles.intro}>I’m Nate Tillman — a front-end software developer and U.S. Army veteran combining React and JavaScript skills with 15 years of leadership, logistics, training, and mission-focused execution.</p><div className={styles.heroActions}><a href='#projects' className={styles.primary}>Explore my work <span aria-hidden='true'>↗</span></a><a href='#contact-form' className={styles.textLink}>Start a conversation</a></div></div>
    ...
    <footer className={styles.siteFooter}><span>© {new Date().getFullYear()} Nate Tillman</span><span>Hinesville, Georgia</span></footer>
  </main>;
}
