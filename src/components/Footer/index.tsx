        ...
        <div className="relative mx-auto max-w-[1170px] px-4 pt-17.5 sm:px-8 xl:px-0">
          ...
          <div className="flex flex-wrap justify-between">
            <div className="mb-10 w-full max-w-[520px]">
              <Link
                href="/"
                aria-label="Nate Tillman — home"
                className="mb-8.5 inline-block text-[30px] font-semibold tracking-[-0.08em] text-white no-underline"
              >
                N<span className="text-[#d72b24]">.</span>
              </Link>
